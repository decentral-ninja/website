...
self.Environment = {
  ...
  keepAlive: 86400000,
  version: currentScriptUrl.searchParams.get('version') || document.documentElement.getAttribute('version') || '4.4.9', // https://semver.org/
  timestampNamespace: 't_',
  awarenessEventListenerDelay: 2000, // the delay to react on events like 'yjs-users' or 'yjs-providers' 
  /**
