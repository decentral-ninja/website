...
self.Environment = {
  ...
  version: `version=${currentScriptUrl.searchParams.get('version') || document.documentElement.getAttribute('version') || '2.1.18'}`, // https://semver.org/
  roomNamePrefix: 'chat-',
  ...
  trackers: [
    'wss://tracker.peerweb.site/announce',
