...
export default class IconCombinations extends Shadow() {
  ...
  fetchTemplate () {
    ...
    switch (this.getAttribute('namespace')) {
      case 'icon-combinations-double-keys-':
        return this.fetchCSS([{
          // @ts-ignore
          path: `${this.importMetaUrl}./double-keys-/double-keys-.css`,
          namespace: false,
          replaces
        }], false)
      case 'icon-combinations-add-key-':
        return this.fetchCSS([{
          // @ts-ignore
          path: `${this.importMetaUrl}./add-key-/add-key-.css`,
          namespace: false,
          replaces
        }], false)
      default:
