          ...
          <main>
            <div class=pattern>
              <div class=content>
                ...
                <p>DCN supports multiple connection methods (webrtc, websocket, trystero - BitTorrent, Nostr, MQTT, IPFS), see <a href="?page=/how" route target="_self">how to use? - provider list <wct-icon-mdx title="providers" icon-url="../../../../../../img/icons/network.svg" size="1em"></wct-icon-mdx></a>. Websockets allow a temporary storage, so that data syncs when users are offline (see keepAlive). It can also acts as a notification service.</p>
                <hr>
